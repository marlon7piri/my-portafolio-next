        ...
        >
          ...
          <div className="flex ">
            <a
              ...
              target="_blank"
              className=" w-max h-max text-complementario p-3 rounded-full flex justify-center items-center text-3xl shadow-inner shadow-blanco hover:scale-105 trasition duration-500 cursor-pointer"
            >
              {" "}
