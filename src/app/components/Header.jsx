    ...
    <header className="header_container">
      ...
      <div className="w-full h-screen flex justify-start p-24 ">
        ...
        >
          ...
          <p className="text-complementario">Programador Full Stack</p>
          <div className="flex gap-2">
            <a
              href="https://www.linkedin.com/in/marlon-rodriguez-rivera/"
              target="_blank"
              className=" w-max h-max text-complementario p-3 rounded-full flex justify-center items-center text-3xl shadow-inner shadow-complementario hover:scale-105 trasition duration-500 cursor-pointer hover:shadow-primario"
            >
              {" "}
